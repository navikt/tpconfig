...
public class Endpoint<E, T> implements HttpHandler {
    ...
    private Function<E, T> createResultFromInput;
    private String path;

    Endpoint(Metrics metrics, Function<HttpServerExchange, E> extractInputFromExcange, Function<E, T> createResultFromInput, String path) {
    ...
    public void handleRequest(HttpServerExchange exchange) {
        ...
        try {
            ...
            exchange.getResponseSender().send(responseString.toString());
