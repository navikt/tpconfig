...
public class EndpointFactory {
    ...
    public static Endpoint<String> createServiceAccountEndpoint(TpConfig tpConfig){
        return new Endpoint<>(METRICS_FOR_SERVICEACCOUNT_ENDPOINT, Utlis.urlParamExtractor(TPNR_URL_PARAMETER_NAME), tpConfig::serviceaccount, SERVICE_ACCOUNT_PATH);
    }

    public static Endpoint<String> createTpNrToTPLeverandoerEndpoint(TpConfig tpConfig){
        return new Endpoint<>(METRICS_FOR_TPNR_TO_TPLEVERANDOER, Utlis.urlParamExtractor(TPNR_URL_PARAMETER_NAME), tpConfig::leverandoerNameByTPNr, LEVERANDOR_BY_TPNR_PATH);
    }

    public static Endpoint<String> createTssNrToTPLeverandoerEndpoint(TpConfig tpConfig){
        return new Endpoint<>(METRICS_FOR_TSSNR_TO_TPLEVERANDOER, Utlis.urlParamExtractor(TSSNR_URL_PARAMETER_NAME), tpConfig::leverandoerNameByTSSNr, LEVERANDOR_BY_TSSNR_PATH);
    }
